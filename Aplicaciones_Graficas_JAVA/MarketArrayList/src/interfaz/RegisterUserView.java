...
public class RegisterUserView extends javax.swing.JFrame {
    ...
    ArrayList<clases.User> users = new ArrayList<clases.User>();
    ...
    private void btnSignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignupActionPerformed
        ...
        if (status()){
            ...
            if( txtFirstname.getText().equals("") ||  txtLastname.getText().equals("") ||
                    txtMobile.getText().equals("") ||     txtEmail.getText().equals("") ||
                ...
                for (int i = 0; i < users.size(); i++) {
                    System.out.println("Usuario: "+users.get(i).getEmail()+" Clave: "+users.get(i).getPassword());                
                }
               
                JOptionPane.showMessageDialog(null,"::: El usuario ha sido creado. Ahora será redirigido al formulario de inicio de sesión.  :::");
                dispose();
            } else {
