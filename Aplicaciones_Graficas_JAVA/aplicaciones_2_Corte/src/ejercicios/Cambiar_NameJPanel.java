...
public class Cambiar_NameJPanel extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Cambiar_NameJPanel
     */
    
    int lan = 1; //1->English    2->Spanish
    
    public Cambiar_NameJPanel() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cambiar_NameJPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cambiar_NameJPanel().setVisible(true);
            }
        });
    }
